(function($) {
    ...
    $.fn.fSelect = function(options) {
        ...
        fSelect.prototype = {
            ...
            //    var Selall = '<div class="fs-search"><div class="row"><div class="com-sm-6">Select All</div><div class="com-sm-6">Deselect All</div></div>';
            //    this.$wrap.find('.fs-dropdown').prepend(Selall);
